...
<th>
<a href='setInTime.jsp?Eid=<%=id%>' style ="font-family:Garamond;font-size:30px; padding: 1px 15px; color:white; background-color:082032; border-radius:5px;"> Check In</a>
</th>
</tr>
</table>
